...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    MaterialCardView card, card1, card2;
    ...
    // A default location (Nairobi) and default zoom to use when location permission is
    // not granted.
    private final LatLng defaultLocation = new LatLng(1.2921, 36.8219);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(MapsActivity.this, Moreinfo.class));
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                map.addMarker(new MarkerOptions()
                        ...
                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.markeer)));
